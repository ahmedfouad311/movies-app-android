...
class TopRatedSeeAllAdapter(val movieItemCallBack: (movieId: Long) -> Unit): RecyclerView.Adapter<TopRatedSeeAllAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View, val movieItemCallBack: (movieId: Long) -> Unit): RecyclerView.ViewHolder(itemView) {
        fun bindData(movie: TopRatedResponse.Result){
            ...
            itemView.cvTopRatedSeeAllCard.setOnClickListener(){
